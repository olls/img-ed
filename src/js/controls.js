...
controls.init = function (elem, controls_def) {
  ...
  Object.keys(controls_def).forEach(function (key) {
    ...
    if (control.job == 'func') {
      ...
      controls.init(controls_e, control.modal);
